            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-7">
                        <blockquote>
                            <p>
                                BANTUAN ini memberikan jawaban atas pertanyaan dasar tentang ChildCare. Lihat Bantuan Lanjutan kami untuk informasi teknis lebih lanjut.
                            </p>
                            <h4>
                                Bantuan Dasar:
                            </h4>
                            <ol>
                                <a href="#t01"><li> Apa Itu ChildCare?</li></a>
                                <a href="#t03"><li>Apa Kelebihan ChildCare dibandingkan pendataan manual</li></a>
                                <a href="#t05"><li>Apakah ChildCare Kompatible dengan smartphone saya?</li></a>
                            </ol>
                            <h4>
                                Bantuan Lanjutan:
                            </h4>
                            ...
                            <div>
                                <h4 id="t02">Apa Itu ChildCare?</h4>
                                <p>ChildCare adalah aplikasi berbasis web yang bermanfaat sebagai perantara untuk melakukan pendataan secara praktis. </p>
                            </div><hr style="height: 2px; background-color: black;">
                            <div id="t03" style="height: 300px;"></div>

                            <div id="t04">
                                <h4>Apa Kelebihan ChildCare dibandingkan pendataan manual</h4>
                            ...
                            <div id="t06">
                                <h4>Apakah ChildCare Kompatible dengan smartphone saya?</h4>
                                <p>Tidak, untuk saat ini website ChildCare hanya tersedia untuk pengguna laptop atau pc saja dikarenakan website masih dalam tahap perkembangan. </p>
                            </div><hr style="height: 2px; background-color: black;">
