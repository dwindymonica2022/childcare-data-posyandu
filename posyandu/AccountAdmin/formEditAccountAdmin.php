    ...
    <fieldset>
        <form class="form-horizontal shadow p-3 mb-5 bg-body rounded bg-light">
            <h3>Edit Akun</h3><br>
                        ...
                        <div class="form-group"> 
                            <label for="current_password" id="label">Password Saat Ini</label>
                            <input type="password" class="form-control" id="current_password">
                        </div>
                        <div class="form-group"> 
                            <label for="new_password" id="label">Password Baru</label>
                            <input type="password" class="form-control" id="new_password">
                        </div>
                        <div class="form-group"> 
                            <label for="confirm_password" id="label">Konfirmasi Password</label>
