   ...
   <div id="wrapper">
    <div id="container">
      <nav class="navbar bg-light">
        <a class="navbar-brand" onclick="window.location.href='home3.php'">
          ...
          <p class="d-inline-block align-middle" id="judul">ChildCare </p>
        </a> 
        <div class="nav-item dropleft">
          <a class="nav-link " href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/login.png" width="70px"></a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="AccountAdmin/formEditAccountAdmin.php">Edit Akun</a>
              <a class="dropdown-item" href="Crud_Account/accountPetugas.php">Akun Petugas</a>
    ...
    <footer class="bg-light text-start">
      ...
      <div class="container p-2">
		...
		?> </h5>
            <p>
              ChildCare adalah sebuah website yang dirancang sedemikian rupa untuk pendataan data imunisasi yang mempermudah petugas posyandu dalam melakukan pendataan. 
            </p>
          </div>
          <span id="muncul"></span>
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            <br><br><br><br><br><br>
            <p class="text-dark text">© 2021 Copyright: Seven team, PT. Diamond
            </p>
          </div>
        </div>
      </div>
