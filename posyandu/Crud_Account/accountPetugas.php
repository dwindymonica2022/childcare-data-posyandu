  ...
  <div id="wrapper">
    <div id="container">
      <div id="content1" style="margin-left: 230px; margin-top: 130px;">
          ...
          <button type="button" onclick="window.location.href='tambahAccountPetugas.php'" class="btn shadow-sm p-2 bg-success rounded" id="button" style="margin-top: 10px;">Tambah Akun Petugas</button><br><br>
          		<table id="ttable"border="0" class="table table-hover table-light table-striped">
              <thead class="bg-dark">
                  <tr class="text-white text-center">
                      <th class="align-middle">ID Akun</th>
